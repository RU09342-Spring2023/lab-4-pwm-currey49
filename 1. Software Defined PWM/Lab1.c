...
void TimerA0Setup(){
    ...
    TB0CCR1 = SET_DUTY_CYCLE;                 // Set CCR1 to the duty cycle
}

void TimerA1Setup(){
    // Setup Timer 1 for RED LED
    ...
    TB1CCR1 = SET_DUTY_CYCLE;                 // Set CCR1 to the duty cycle
}
...
__interrupt void Port_2(void)
{
    ...
    if (TB0CCR1 >= 1000)                           // If duty cycle is 100%
        TB0CCR1 = 100;                              // Set brightness to 10%
    else
...
__interrupt void Port_4(void)
{
    ...
    if (TB1CCR1 >= 1000)                           // If duty cycle is 100%
        TB1CCR1 = 100;                              // Set brightness to roughly 10%
    else
